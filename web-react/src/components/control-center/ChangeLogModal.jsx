...
const RELEASES = [
    ...
    { version: '7.22.3', date: 'AUG 06, 2026', color: '#94a3b8', items: [
        '<strong>Fixed:</strong> Switching the Mileage Tracker between Maps Autopilot and Manual Entry no longer clears the date, name, or notes you already typed.',
        '<strong>Improved:</strong> Editing an existing trip now opens in the main "Log New Trip" form instead of a cramped inline row — so you can attach or change an invoice link while editing, and a previously-linked invoice is automatically re-selected for you.',
    ]},
    ...
    { version: '7.15.3', date: 'JUL 6, 2026', color: '#94a3b8', items: [
        '<strong>Cleanup:</strong> Additional backend safety hardening around the weekly digest fix — no visible changes.',
    ]},
    ...
    { version: '7.11.0', date: 'JUL 2, 2026', color: '#4c7dff', items: [
        ...
        '<strong>Improved:</strong> Alert and confirmation popups now match the app theme.',
    ]},
    { version: '7.10.21', date: 'JUL 1, 2026', color: '#94a3b8', items: [
        '<strong>Cleanup:</strong> Annual database security review — tightened an access policy on internal activity-tracking data.',
    ]},
    ...
    { version: '7.10.17', date: 'JUL 1, 2026', color: '#94a3b8', items: [
        '<strong>Cleanup:</strong> Internal maintenance for the bank connection alerts released above.',
    ]},
    ...
    { version: '7.10.13', date: 'JUL 1, 2026', color: '#94a3b8', items: [
        '<strong>Cleanup:</strong> Backend account security hardening.',
    ]},
    ...
    { version: '7.10.9', date: 'JUL 1, 2026', color: '#f97316', items: [
        ...
        '<strong>New — Plaid Reconnect Status:</strong> Connected bank accounts now show a "⚠️ Reconnect" badge when the connection actually needs re-authentication, with a one-click button to fix it — instead of silently failing to pull new transactions with no warning.',
    ]},
