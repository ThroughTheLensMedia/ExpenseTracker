...
| **E3 — Core financial workflows** | Improve transaction review, saved views, account metric clarity, tax guidance, and mileage fallback messaging. | Implemented locally 2026-09-09; 14 focused tests, scoped lint, and production build pass. Awaiting protected preview validation; no production release. |
