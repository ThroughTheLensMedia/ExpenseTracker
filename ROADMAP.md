...
| **E4.2 — Document workflow** | Make document upload, organization, retrieval, and failure recovery easier to understand without changing storage or AI extraction architecture. | Not started |
