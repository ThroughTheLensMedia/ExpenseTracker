...
| **E2 — Dashboard decisions and Assistant trust** | Prioritize next actions, clarify metrics, and reconcile Assistant capability guidance with the tools it can actually use. | Implemented locally 2026-09-09; focused tests and production build pass. Awaiting protected-preview validation; no production release. |
